...
class TelaCliente(TelaAbstrata):
    ...
    def pega_dados_de_cliente(
        ...
        layout = [
            [
                sg.Text(
                    "Cadastrar cliente" if nome == "" else "Atualizar cliente",
                    font=("Arial", 24),
            ...
            [sg.Text("")],
            [
                sg.Text("CPF*:", size=SIZE_TEXT),
                sg.InputText("", key="cpf", size=SIZE_INPUT_TEXT),
            ]
            if nome == ""
            else [],
            [
                sg.Text("Nome*:", size=SIZE_TEXT),
                sg.InputText(nome, key="nome", size=SIZE_INPUT_TEXT),
            ],
            [sg.Text("")],
            [sg.Text("Endereço"), sg.Push()],
            [
                sg.Text("CEP:", size=SIZE_TEXT),
                sg.InputText(cep, key="cep", size=SIZE_INPUT_TEXT),
            ],
            [
                sg.Text("Estado:", size=SIZE_TEXT),
                sg.InputText(estado, key="estado", size=SIZE_INPUT_TEXT),
            ],
            [
                sg.Text("Cidade:", size=SIZE_TEXT),
                sg.InputText(cidade, key="cidade", size=SIZE_INPUT_TEXT),
            ],
            [
                sg.Text("Bairro:", size=SIZE_TEXT),
                sg.InputText(bairro, key="bairro", size=SIZE_INPUT_TEXT),
            ],
            [
                sg.Text("Rua:", size=SIZE_TEXT),
                sg.InputText(rua, key="rua", size=SIZE_INPUT_TEXT),
            ],
            [
                sg.Text("Número:", size=SIZE_TEXT),
                sg.InputText(numero, key="numero", size=SIZE_INPUT_TEXT),
            ],
        ...
        self.janela = sg.Window(
            "Cadastro de cliente" if nome == "" else "Atualização cliente",
            layout,
