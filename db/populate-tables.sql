...
('12345678909', 'João Silva', 'joao.silva@example.com', 'senha123'),
...
('Entrega Rápida', 15.0, 'Entrega em até 24 horas', 24),
('Entrega Econômica', 5.0, 'Entrega em até 7 dias úteis', 168);

-- Insert into clientes
INSERT INTO clientes (cpf, nome, cep, estado, cidade, bairro, rua, numero) VALUES
('12345678909', 'Carlos Pereira', '01001000', 'SP', 'São Paulo', 'Centro', 'Rua A', '123'),
...
INSERT INTO entregas (remetente_cpf, remetente_nome, destinatario_cpf, destinatario_nome, funcionario_cpf, funcionario_nome, encomenda_id, tipo_de_entrega_id, tipo_de_entrega_nome, tipo_de_entrega_taxa, distancia, created_at) VALUES
('12345678909', 'João Silva', '98765432100', 'Maria Oliveira', '12345678909', 'João Silva', 1, 1, 'Entrega Rápida', '15.0', 100.0, CURRENT_TIMESTAMP),
('98765432100', 'Maria Oliveira', '12345678909', 'João Silva', '98765432100', 'Maria Oliveira', 2, 2, 'Entrega Econômica', '5.0', 500.0, CURRENT_TIMESTAMP);
