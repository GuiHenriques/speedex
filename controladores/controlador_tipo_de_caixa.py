...
class ControladorTipoDeCaixa:
    ...
    def incluir_tipo_de_caixa(self):
        ...
        nova_caixa = Caixa(
            dados_tipo_de_caixa["altura"],
            dados_tipo_de_caixa["largura"],
            dados_tipo_de_caixa["comprimento"],
        )
        novo_tipo_de_caixa = TipoDeCaixa(
            dados_tipo_de_caixa["nome"], dados_tipo_de_caixa["taxa"], nova_caixa
        )

        cadastrado, msg_error = self.__repositorio.registrar_tipo_de_caixa(
            novo_tipo_de_caixa
        )
        if cadastrado:
    ...
    def alterar_tipo_de_caixa(self):
        ...
        tipo_de_caixa = self.__repositorio.pegar_tipo_de_caixa_por_id(
            codigo_selecionado
        )
        if tipo_de_caixa is not None:
            ...
            self.__cursor.execute(
                "UPDATE tipo_de_caixa SET nome = %s, taxa = %s, altura = %s, largura = %s, comprimento = %s WHERE id = %s",
                (
                    dados_tipo_de_caixa["nome"],
                    dados_tipo_de_caixa["taxa"],
                    dados_tipo_de_caixa["largura"],
                    dados_tipo_de_caixa["altura"],
                    dados_tipo_de_caixa["comprimento"],
                    codigo_selecionado,
    ...
    def gerar_tipo_de_caixa_cliente(self, dados_caixa):
        caixa = Caixa(
            dados_caixa["altura"], dados_caixa["largura"], dados_caixa["comprimento"]
        )
